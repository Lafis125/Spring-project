		      ...
		      if (fileInput.files && fileInput.files[0]) {
		          ...
		          reader.onload = function(e) {
		              ...
		              $("#detailImageDiv").remove();
		           	...
		           	// 이미지 업로드 시 새 이미지에 기존 이미지의 image-no 추가
				...
				<c:if test="${imageVO2.pr == 0}">
					<div class="imgDiv img-detail"
						...
						<img alt="${imageVO2.file_name}" src="${imageVO2.file_name}"
							...
							data-image_no="${imageVO2.image_no}">
							<button class="delete-detail" data-image_no="${imageVO2.image_no}" data-file_name=${imageVO2.file_name }>X</button>
					</div>
