...
import com.ikeo.product.service.ProductService;
...
public class ProductController {
	...
	public String view(Long no, Model model) throws Exception {
		...
		ProductPageObject pageobject = new ProductPageObject();
		pageobject.setPerPageNum(8L);
		pageobject.setItem_no(no);
		model.addAttribute("reviewlist", reviewservice.list(pageobject));
		String strno = Long.toString(no);
		model.addAttribute("qnalist", qnaservice.list(pageobject, strno));
